...
var FORM_SELECTOR = '[data-search="search-form"]';
var INPUT_SELECTOR = '[data-search="search-input"]';
var LIST_SELECTOR = '[data-chat="article-list"]';

var NooslyApp = function NooslyApp() {
	var _this = this;

	_classCallCheck(this, NooslyApp);

	this.searchForm = new _dom.SearchForm(FORM_SELECTOR, INPUT_SELECTOR);
	this.searchList = new _dom.SearchList(LIST_SELECTOR);

	console.log('Welcome to Noozly!');

	_wsClient2.default.init('ws://localhost:3001');
	_wsClient2.default.registerOpenHandler(function () {
		_this.searchForm.init(function (data) {
			var message = data;
			_wsClient2.default.sendMessage(data);
		});
	});
	...
	_wsClient2.default.registerMessageHandler(function (data) {
		...
		_this.searchList.drawArticle(data);
	});
};

var Keyword = function () {
	function Keyword(_ref) {
		var m = _ref.message;
...
exports.SearchList = exports.SearchForm = undefined;
...
var SearchForm = exports.SearchForm = function () {
  function SearchForm(formSel, inputSel) {
...
var SearchList = exports.SearchList = function () {
  ...
  _createClass(SearchList, [{
    key: 'drawArticle',
    value: function drawArticle(_ref) {
      var t = _ref.title,
          d = _ref.description,
          l = _ref.link,
          u = _ref.url,
      ...
      var $articleRow = (0, _jquery2.default)('<li>', {
        'class': 'article-row'
      });

      var $article = (0, _jquery2.default)('<div>', {
        'class': 'row'
      });

      var $image = (0, _jquery2.default)('<div>', {
        'class': 'col-md-3'
      });

      var $title_desc = (0, _jquery2.default)('<div>', {
        'class': 'col-md-7'
      });

      $image.append((0, _jquery2.default)('<img>', {
      ...
      $title_desc.append((0, _jquery2.default)('<h3>', {
        'class': 'article-title',
        text: t
      }));

      $title_desc.append((0, _jquery2.default)('<p>', {
        'class': 'article-desc',
        text: d
      }));

      $title_desc.append((0, _jquery2.default)('<a>', {
      ...
      (0, _jquery2.default)("#search-list").append($articleRow);
